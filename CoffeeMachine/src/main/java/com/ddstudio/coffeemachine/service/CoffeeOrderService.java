...
import com.ddstudio.coffeemachine.util.SMSUtility;
...
public class CoffeeOrderService {
	...
	public List<DrinkVo> getAllDrinks(){
		List<DrinkVo> drinkVoList = orderDao.getAllDrinks();
		return drinkVoList;
	}
	...
	public int getCurrentRoom() {
		return orderDao.getCurrentRoom();
	}
	
	public List<OrderVo> getOrders(int roomId) {
		return orderDao.getOrders(roomId);
	}
	
//	public int sendSMS(RoomVo roomVo) {
//		//문자 보내는 API 호출
//		
//		String api_key = "NCS5465AD7DDE621";
//	    String api_secret = "1A8D5CA6BB0D72A1E25DAE8B3E42622C";
//	    Message coolsms = new Message(api_key, api_secret);
//
//	    // 4 params(to, from, type, text) are mandatory. must be filled
//	    HashMap<String, String> params = new HashMap<String, String>();
//	    params.put("to", "01020077774"); // 수신번호
//	    params.put("from", "01052274071"); // 발신번호
